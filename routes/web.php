...
// Route::post('/level/tambah_simpan', [LevelController::class, 'store'])->name('level.tambahsimpan');
...
Route::group(['prefix' => 'stok'], function () {
    ...
    Route::get('/{id}', [StokController::class, 'show']); // menampilkan detail stok barang
    Route::get('/{id}/edit', [StokController::class, 'edit']); // menampilkan halaman form edit stok barang
...
Route::group(['prefix' => 'penjualan'], function () {
    ...
    Route::post("/list_barang", [PenjualanController::class, "list_barang"]); //menampilkan list barang
